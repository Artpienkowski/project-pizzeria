  ...
  class Product{
    ...
    processOrder(){
      ...
      for(let paramId in thisProduct.data.params) {
        ...
        // determine option value, e.g. optionId = 'olives', option = { label: 'Olives', price: 2, default: true }
          ...
          const optionImage = thisProduct.dom.imageWrapper.querySelector('.' + paramId + '-' + optionId); // gdzie w kodzie jest ten selector? Potrzebuję dokładniejszego objaśnienia zasady wyboru tego selektora
          if(optionImage) {
            if(optionSelected) {
    ...
    prepareCartProductParams(){
      ...
      for(let paramId in thisProduct.data.params) {
        ...
        // create category param in paramas const eg. params = { ingredients: { name: 'Ingredients', options: {}}}
        params[paramId] = {
          label: param.label,
          options: {}
        };
